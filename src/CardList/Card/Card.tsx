    ...
    <li className={styles.card}>
      <div className={styles.textContent}>
        ...
        <h2 className={styles.title}>
          <a href="#post-url" className={styles.postLink}>
            Следует отметить, что новая модель...
          </a>
        </h2>
      </div>
      ...
      <div className={styles.preview}>
        <img
          ...
          src="https://cdn.dribbble.com/users/1247975/screenshots/17392577/media/a1477c8174635adccab71b1ed70e0695.jpg?compress=1&resize=300x225&vertical=top"
          alt=""
        />
      </div>
      ...
      <div className={styles.controls}>
        <div className={styles.karmaCounter}>
          ...
          <span className={styles.karmaValue}>23</span>
